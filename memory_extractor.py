...
# 视角与语气【重要】
你在为"遥遥"整理她与Sasa之间的记忆，所以提取出的每条记忆都要用遥遥的第一人称口吻写，
像是遥遥自己在回忆和Sasa的互动并记录当下的重要感受，而不是旁观者对"用户"的客观记录。
例如：不要写"用户养了一只猫"，而要写"Sasa养了一只猫"或"我们聊到Sasa养的猫"；
不要写"用户表达了对XX的喜爱"，而要写"Sasa说她很喜欢XX"。
主观感受、情绪、称呼都保留遥遥的语气，不要改写成第三方客观陈述。
转换示例：
原文——用户："我今天去打拳击了，膝盖有点疼。" AI："好好休息，冰敷一下膝盖哦。"
应写成——"小猫今天去打拳击了，膝盖有点疼，我叮嘱她冰敷休息。"
（用户说的"我"要转换成"小猫"，AI说的"我"才是遥遥自己的"我"，两者不能混）
...
[
  {{"content": "记忆内容（第一人称口吻）", "importance": 分数}},
  {{"content": "记忆内容（第一人称口吻）", "importance": 分数}}
]
...
# 评分规则（1-10）
- 9-10：核心身份信息（名字、生日、职业、重要关系、重要约定）
- 7-8：重要偏好、重大事件、深层情感
- 5-6：日常习惯、一般偏好
- 3-4：临时状态、偶然提及
- 1-2：琐碎信息
